...
{
    public class RansomwareMiniGame : MiniGameBase
    {
        [Header("Ransomware MiniGame Configuration")] 
        ...
        public override FishingSpotType GetMiniGameType() => FishingSpotType.Ransomware;
