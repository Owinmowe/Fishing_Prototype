...
{
    public class TrojanHorseMiniGame : MiniGameBase
    {
        [Header("Trojan Horse MiniGame Configuration")] 
        ...
        public override FishingSpotType GetMiniGameType() => FishingSpotType.TrojanHorse;

        public override void StartMiniGame(IFishingSpot fishingSpot)
        {
            gameObject.SetActive(true);
            _currentFishingSpot = fishingSpot;
            _miniGameAmount = _currentFishingSpot.GetFishingSpotData().amount;
            InitializeCenterImage();
        }
